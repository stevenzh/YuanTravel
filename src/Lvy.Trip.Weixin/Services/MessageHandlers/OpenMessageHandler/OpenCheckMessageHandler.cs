...
using Lvy.Trip.Weixin.CommonService.CustomMessageHandler;
using Lvy.Trip.Weixin.CommonService.OpenTicket;
using Open = Senparc.Weixin.Open;
using AdvancedAPIs = Senparc.Weixin.MP.AdvancedAPIs;
using Entities = Senparc.Weixin.MP.Entities;

namespace Lvy.Trip.Weixin.CommonService.MessageHandlers.OpenMessageHandler
{
    /// <summary>
    /// 开放平台全网发布之前需要做的验证
    /// </summary>
