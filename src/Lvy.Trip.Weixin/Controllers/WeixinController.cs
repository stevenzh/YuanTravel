...
namespace Lvy.Trip.Weixin.Controllers
{
    ...
    public partial class WeixinController : Controller
    {
        ...
        private static readonly string EncodingAESKey = WebConfigurationManager.AppSettings["WeixinAppSecret"];
        ...
        /// <summary>
        /// 微信后台验证地址（使用Get），微信后台的“接口配置信息”的Url填写如：http://yuanwx.sh-cct.cn/weixin
        /// </summary>
        [HttpGet]
        [ActionName("Index")]
