...
using Lvy.Trip.Weixin.CommonService.WxOpenMessageHandler;
using Lvy.Trip.Weixin.CommonService.TemplateMessage.WxOpen;

namespace Lvy.Trip.Weixin.Controllers.WxOpen
{
    /// <summary>
    /// 微信小程序Controller
    /// </summary>
