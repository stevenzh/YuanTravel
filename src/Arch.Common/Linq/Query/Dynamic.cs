...
namespace System.Linq.Dynamic
{
    public static class DynamicQueryable
    {
        ...
        public static IQueryable<T> OrderBy<T>(this IQueryable<T> source, string sortExpression, bool IsAscending)
        {
...
#pragma warning restore 0219
        ...
        int FindMethod(Type type, string methodName, bool staticAccess, Expression[] args, out MethodBase method)
        {
            if (methodName == "First")
            {
                ...
                Assembly assembly = Assembly.LoadFrom(@"D:\Program Files\Reference Assemblies\Microsoft\Framework\v3.5\System.Core.dll");
                //Assembly assembly = Assembly.LoadFrom(@"D:\Program Files\Reference Assemblies\Microsoft\Framework\v3.5\System.Core.dll");
