...
{
    public class WeixinDbRepository<T> : BaseRepository, IRepository<T>
    {
        public WeixinDbRepository()
        {
            _repo = new Database("YuanDB", "MySql.Data.MySqlClient");
        }

        public ITransaction GetTransaction()
        {
            return _repo.GetTransaction();
        }

        public bool IsNew(T obj)
        {
            return _repo.IsNew(obj);
        }
        ...
        public int Update(T obj, IEnumerable<string> columns)
        {
            return _repo.Update(obj, columns);
        }
        ...
        {
            return _repo.Update<T>(sql, args);
        }
        ...
        ITransaction IRepository<T>.GetTransaction()
        {
            return _repo.GetTransaction();
        }
    }
