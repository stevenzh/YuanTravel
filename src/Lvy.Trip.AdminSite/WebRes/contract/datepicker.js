...
(function($, document, window, undefined) {
    ...
    Plugin.prototype = {
        ...
        _init: function() {
            ...
            this.initValue = this.options.initValue;
            ...
            switch (this.mode) {
                ...
                case 'multiple':
                    ...
                    // console.log(this.options.isShowButtons);
                    break;
            }
            ...
            if(this.options.isShowButtons) {
                this.$picker.append('<div class="'+this.namespace+'-select-buttons"><span class="button" data-type="-1">清空</span> <span class="button" data-type="0">全选</span> <span class="button" data-type="1">每周一</span> <span class="button" data-type="2">每周二</span> <span class="button" data-type="3">每周三</span> <span class="button" data-type="4">每周四</span> <span class="button" data-type="5">每周五</span> <span class="button" data-type="6">每周六</span> <span class="button" data-type="7">每周日</span></div>')
            }
        ...
        _selectDate: function(i) {
            // console.log(this._date)
            var _this = this;
            // $('.calendar-row').find('span').each(function(index, obj) {
            //  // $(obj).trigger('click');
            //  // $(this).trigger('click');
            //  console.log(index);
            //  _this._updateDate(index);
            // })


            var currentDate = this._date.currentDate;
            for(var k in currentDate) {
                currentDate[0].setDate(1);
                currentDate[0].setHours(0, 0, 0, 0);
            }
        },
        ...
        _position: function() {
            ...
            var calendar_height = this.$picker.outerHeight(),
                ...
                // console.log(input_top, calendar_height, container_height)
            if(input_top+calendar_height > container_height && position == 'bottom') {
                position = 'top'
            }
            ...
            left = this.$el.offset().left + scroll_left;
            this.$picker.css({
                "left": left,
                "top": top
            });
        ...
        _click: function(e) {
            ...
            if ($target.closest(this.$inputIcon).length === 0 && $target.closest(this.$picker).length === 0 && $target.closest(this.$el).length === 0 && this.options.alwaysShow === false) {
                ...
                } else if(_target.parent('.' + this.namespace + '-months').length === 1) {
                    // this._updateDate(0);
                    // this._manageViews(0);
                }

                // console.log(_target,'.' + this.namespace + '-select-buttons');

                if (_targetSpan.length === 1) {
                    // console.log('222')
                    var j = _targetSpan.parents('.' + this.namespace + '-content').index();

                    if(_target.hasClass(this.namespace + '-select-buttons')) {


                        var _thisDate = this._date;
                        this._date.selectedDate = [];
                        var currentDate=this._date.currentDate;
                        var selectedDate = this._date.selectedDate;

                        // console.log();

                        var _type = _targetSpan.data('type');
                        switch(_type) {
                            case -1:
                                //清空
                                selectedDate = [];
                            ...
                            case 0:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    var _month = _thisDate.currentMonth[i];
                                    for(var j=0; j<31; j++) {
                                        var time = (currentDate[i]/1000+86400*j)*1000;
                                        var _now = new Date(time);
                                        // console.log(_now.getMonth());

                                        if(_now.getMonth() === _month) {
                            ...
                            case 1:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    ...
                                    for(var j=0; j<31; j++) {
                                        ...
                                        if(_now.getMonth() === _month && _now.getDay()===1) {
                                            selectedDate.push(time);
                                        }
                                    }
                                }
                            ...
                            case 2:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    ...
                                    for(var j=0; j<31; j++) {
                                        ...
                                        if(_now.getMonth() === _month && _now.getDay()===2) {
                                            selectedDate.push(time);
                                        }
                                    }
                                }
                            ...
                            case 3:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    ...
                                    for(var j=0; j<31; j++) {
                                        ...
                                        if(_now.getMonth() === _month && _now.getDay()===3) {
                                            selectedDate.push(time);
                                        }
                                    }
                                }
                            ...
                            case 4:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    ...
                                    for(var j=0; j<31; j++) {
                                        ...
                                        if(_now.getMonth() === _month && _now.getDay()===4) {
                                            selectedDate.push(time);
                                        }
                                    }
                                }
                            ...
                            case 5:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    ...
                                    for(var j=0; j<31; j++) {
                                        ...
                                        if(_now.getMonth() === _month && _now.getDay()===5) {
                                            selectedDate.push(time);
                                        }
                                    }
                                }
                            ...
                            case 6:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    ...
                                    for(var j=0; j<31; j++) {
                                        ...
                                        if(_now.getMonth() === _month && _now.getDay()===6) {
                                            selectedDate.push(time);
                                        }
                                    }
                                }
                            ...
                            case 7:
                                ...
                                for(var i=0; i<currentDate.length; i++) {
                                    ...
                                    for(var j=0; j<31; j++) {
                                        ...
                                        if(_now.getMonth() === _month && _now.getDay()===0) {
                                            selectedDate.push(time);
                                        }
                                    }
                                }
                        ...
                        this._date.selectedDate = selectedDate;
                        for (var i = 0; i < this.calendarsNum; i++) {
                            this._manageViews(i);
                        }
                        this._setValue();

                    } else if (!_targetSpan.hasClass(this.namespace + '_otherMonth') && !_targetSpan.hasClass(this.namespace + '_untouchable') && _targetSpan.parent('.' + this.namespace + '-head').length !== 1) {
                ...
                if (!this.isMobile) {
                    var hasMonth = $(e.target).attr('class').indexOf('month');
                    if (hasMonth<0 && this.selected === true && this.options.alwaysShow === false && this.options.onceClick === true) {
                    // if ($(e.target).parent('div').parent('div').hasClass(this.namespace+'-body') && this.selected === true && this.options.alwaysShow === false && this.options.onceClick === true) {
                        this.hide();
                    } else {
                        if (this.options.displayMode === 'dropdown') {
                            this.$el.focus();
