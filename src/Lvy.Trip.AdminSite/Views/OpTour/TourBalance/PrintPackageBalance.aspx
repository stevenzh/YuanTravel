...
<body>
    ...
    <script runat="server">
        ...
        private void Page_Load(Object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("PayInDataSet", model.PayInList));
    ...
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" Width="100%" ProcessingMode="Local"
            ...
            <LocalReport ReportPath="Views\RDLC\Balance.rdlc" EnableExternalImages="true">
            </LocalReport>
        </rsweb:ReportViewer>
